package com.parcial.videojuegos.services;

import com.parcial.videojuegos.entities.Videojuego;
import com.parcial.videojuegos.repositories.RepositorioVideojuego;
...
public class  ServicioVideojuego implements ServicioBase<Videojuego>{
    ...
    @Transactional
    public List<Videojuego> findByTitle(String q) throws Exception{ //Como parametro recibimos la qwery
        try{
